...
typedef enum {
     ...
     */
    rl_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    rl_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    rl_propertyMemoryManagementPolicyCopy
} rl_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #rl_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    rl_propertyMemoryManagementPolicy memoryManagementPolicy;
